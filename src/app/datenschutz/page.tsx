...
export default function DatenschutzPage() {
  return (
    <main className="mx-auto max-w-2xl px-5 py-14 text-[0.9375rem] leading-relaxed text-ash">
      <h1 className="display text-[2.2rem]">Datenschutzerklärung</h1>

      <h2 className="mt-10 display-tight text-lg text-chalk">1. Verantwortlicher</h2>
      <p className="mt-3">
        [VOR- UND NACHNAME / FIRMA], [ANSCHRIFT], E-Mail: [E-MAIL-ADRESSE]
      </p>

      <h2 className="mt-10 display-tight text-lg text-chalk">2. Feedback über Tisch-Karten (Gäste)</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 display-tight text-lg text-chalk">3. Weiterleitung zu Google</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 display-tight text-lg text-chalk">4. Konten für Gastronomiebetriebe</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 display-tight text-lg text-chalk">5. Hosting</h2>
      <p className="mt-3">
      ...
      <h2 className="mt-10 display-tight text-lg text-chalk">6. Ihre Rechte</h2>
      <p className="mt-3">
